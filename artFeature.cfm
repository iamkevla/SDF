	...
	<div id="content">
		...
		<div id="maincontent">
			<div id="introduction">
				...
				<p>	Feature Maps are a simple visual represenation of the requirements as feature blocks 
...
feature duplication.<br /><br />
				</p>
 				<p> Each feature block is cross-referenced at all times with the requirements and are named 
using verbNoun usage captured with the Requirement. Feature blocks are marked with relative complexity (Easy, Medium, 
Complex & Special Case ).<br /><br />
				</p>
